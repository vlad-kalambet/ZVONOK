    ...
    <div class="content container">
        <div class="row">
            <div class="col-md-12 text-align-center row margin-bottom">
                ...
                <h2 class="page-title">Управление охраной.</h2>
                    ...
                    <div class="row margin-bottom text-align-center">
                        <div class="col-xs-12">
                            <div class="btn-group btn-group-justified">
                                <div class="btn-group">
                                        <button type="button" class="btn btn-success btn-lg" id="oxr1">
                                            ON
                                        </button>
                                </div>
...
<header>
                    ...
                    <div class="row margin-bottom text-align-center">
                        <div class="col-xs-12">
                            <div class="btn-group btn-group-justified">
                                <div class="btn-group">
                                        <button type="button" class="btn btn-success btn-lg" id="opn1">
                                            Открыть
                                        </button>
                                </div>
                                <div class="btn-group">
                                        <button type="button" class="btn btn-primary btn-lg" id="cls1">
                                            Закрыть
                                        </button>
                                </div>
