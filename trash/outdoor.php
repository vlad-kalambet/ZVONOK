    ...
    <script type="text/javascript">
        $(document).ready(function(){
                $('#on1').click(function(){
                        ...
                        a.open("GET","/pinonoff_php/on1_p.php");
                ...
                $('#off1').click(function(){
                        var a = new XMLHttpRequest();
                        a.open("GET","/pinonoff_php/off1_p.php");
                        a.onreadystatechange=function(){
                                if(a.readyState==4){
                                        if(a.status == 200){
                                        }
                ...
                $('#on2').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on2_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                ...
                $('#off2').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off2_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                ...
                $('#on3').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on3_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                ...
                $('#off3').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off3_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#on4').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on4_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#off4').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off4_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#on5').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on5_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#off5').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off5_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#on6').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on6_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#off6').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off6_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#on7').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on7_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#off7').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off7_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#on8').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on8_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#off8').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off8_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#on9').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on9_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#off9').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off9_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#on10').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on10_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#off10').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off10_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#on11').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on11_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#off11').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off11_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#on12').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on12_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#off12').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off12_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#on13').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on13_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#off13').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off13_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#on14').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on14_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#off14').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off14_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#on15').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on15_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#off15').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off15_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#on16').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/on16_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#off16').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/off16_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#opn1').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/dver/opn1_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#cls1').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/dver/cls1_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#oxr1').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/oxrana_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#tp1').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/tp1_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
                                ...
                                $('#rkiu').click(function(){
                                                var a = new XMLHttpRequest();
                                                a.open("GET","/pinonoff_php/rkiu_p.php");
                                                a.onreadystatechange=function(){
                                                                if(a.readyState==4){
                                                                                if(a.status == 200){
                                                                                }
    ...
    <div class="content container">
        <div class="row">
            <div class="col-md-12 text-align-center row margin-bottom">
                ...
                <h2 class="page-title">Управление уличным освещением.</h2>
                    ...
                    <div class="row margin-bottom text-align-center">
                        <div class="col-xs-12">
                            <div class="btn-group btn-group-justified">
                                <div class="btn-group">
                                        <button type="button" class="btn btn-success btn-lg" id="on16">
                                            ON
                                        </button>
                                </div>
                                <div class="btn-group">
                                        <button type="button" class="btn btn-primary btn-lg" id="off16">
                                            OFF
                                        </button>
                                </div>
...
<header>
                    ...
                    <div class="row margin-bottom text-align-center">
                        <div class="col-xs-12">
                            <div class="btn-group btn-group-justified">
                                <div class="btn-group">
                                        <button type="button" class="btn btn-success btn-lg" id="on10">
                                            ON
                                        </button>
                                </div>
                                <div class="btn-group">
                                        <button type="button" class="btn btn-primary btn-lg" id="off10">
                                            OFF
                                        </button>
                                </div>
