    ...
    <div class="content container">
        <div class="row">
            <div class="col-md-12 text-align-center row margin-bottom">
                ...
                <h2 class="page-title">Управление климатом.</h2>
                    ...
                    <div class="row margin-bottom text-align-center">
                        <div class="col-xs-12">
                            <div class="btn-group btn-group-justified">
                                <div class="btn-group">
                                        <button type="button" class="btn btn-success btn-lg" id="on15">
                                            ON
                                        </button>
                                </div>
                                <div class="btn-group">
                                        <button type="button" class="btn btn-primary btn-lg" id="off15">
                                            OFF
                                        </button>
                                </div>
...
<header>
                    ...
                    <div class="row margin-bottom text-align-center">
                        <div class="col-xs-12">
                            <div class="btn-group btn-group-justified">
                                <div class="btn-group">
                                        <button type="button" class="btn btn-success btn-lg" id="tp1">
                                            ON
                                        </button>
                                </div>
