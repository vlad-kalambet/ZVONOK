    ...
    <ul id="side-nav" class="side-nav">
        ...
        <li class="panel">
            ...
            <ul id="stats-collapse" class="panel-collapse collapse">
                <li><a href="stat_statistics.html">Внутри</a></li>
                <li><a href="stat_charts.html">Снаружи</a></li>
            </ul>
        </li>
        <li class="panel">
            <a href="klimat.html"><i class="fa fa-magic"></i> <span class="name">Климат</span></a>
        </li>
        <li class="panel">
            <a href="oxr.html"><i class="fa fa-table"></i> <span class="name">Охрана</span></a>
        </li>
        <li class="panel">
            <a href="statistic.html"><i class="fa fa-bars"></i> <span class="name">Статистика</span></a>
        </li>
    ...
    <div class="content container">
        <div class="row">
            <div class="col-md-12 text-align-center row margin-bottom">
                ...
                <h2 class="page-title">Система автоматического управления.</h2>
